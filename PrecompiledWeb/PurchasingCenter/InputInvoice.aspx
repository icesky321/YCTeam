<%@ page title="" language="C#" masterpagefile="~/shares/MasterPage.master" autoeventwireup="true" inherits="PurchasingCenter_InputInvoice, App_Web_orgjpqpt" %>
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="profile-details">
                            <li>
                                ...
                                <h4><strong>
                                    <asp:Label ID="lbStatus" runat="server" Text="待收发票"></asp:Label></strong></h4>
                            </li>
                        </ul>
                        <hr>
                        <ul class="profile-details">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>¥8783.98元</td>
                                    <td>
                                        <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/PurchasingCenter/NewInputInvoice.aspx">新增进项发票</asp:HyperLink></td>
                                </tr>
                                <tr>
                                    <td>2
                                    </td>
                                    ...
                                    <td>¥4495844.98元</td>
                                    <td>
                                        <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="~/PurchasingCenter/NewInputInvoice.aspx">新增进项发票</asp:HyperLink></td>
                                </tr>
                                <tr>
                                    <td>2
                                    </td>
                                    ...
                                    <td>¥387485.77元</td>
                                    <td>
                                        <asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="~/PurchasingCenter/NewInputInvoice.aspx">新增进项发票</asp:HyperLink></td>
                                    <td>
                                </tr>
                            </tbody>
                        </table>
